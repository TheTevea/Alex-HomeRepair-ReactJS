...
const AppointmentSection = ({containerClass,headColor,titlColor,descColor,columnSize,headPaddSize,messPaddSize,inputPaddSize,buttonSize,buttonName}) => {
  return (
    <div className={`${containerClass}`}>
        <div className="container-fluid py-5 d-flex justify-content-center">
            ...
            <div className="row">
                ...
                <div className={`col-lg-7  ${messPaddSize ? messPaddSize : "px-3"} ${columnSize}`}>
                    <div className="row">
